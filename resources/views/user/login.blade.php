...
<main class="bg-white max-w-lg mx-auto p-8 my-10 rounded-lg shadow-2xl">
    <section>
        ...
        <p class="text-gray-600 pt-2">Sign up for new account <a href="/register" class="text-blue-300 font-bold">here</a></p> 
    </section>
    <section class="mt-10">
        <form action="/login/process" method="POST" class="flex flex-col">
            ...
            <button type="submit" class="bg-blue-600 hover:bg-purple-700 text-white font-bold py-2 rounded shadow-lg hover:shadow-xl transition duration-200" >Sign In</button>
        </form>
    </section>
</main>
