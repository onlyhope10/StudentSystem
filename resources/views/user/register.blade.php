...
<main class="bg-white max-w-lg mx-auto p-8 my-10 rounded-lg shadow-2xl">
    <section>
        ...
        <p class="text-gray-600 pt-2">Sign in to your account <a href="/login" class="text-blue-300 font-bold">here</a></p> 
    </section>
    <section class="mt-10">
        ...
        <div class="mb-6 pt-3 rounded bg-gray-200">
            ...
            <button class="bg-blue-600 hover:bg-purple-700 text-white font-bold py-2 rounded shadow-lg hover:shadow-xl transition duration-200" type="submit">Sign Up</button>
        </form>
    </section>
</main>
